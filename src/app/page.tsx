...
export default function Page() {
	return (
		<>
			...
			<main
				id='main-content'
				className='container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16 pt-28 md:pt-32'
			>
				<section className='mx-auto w-full max-w-4xl space-y-8 bg-background text-foreground print:space-y-6'>
					<div className='flex flex-col-reverse items-center gap-4 sm:flex-row sm:justify-between animate-fade-in'>
						...
						<a
							href='https://github.com/NateSewel'
							target='_blank'
						...
						>
							<Avatar
								className='size-32 border-2 border-border transition-all duration-300 group-hover:scale-105 sm:size-40 shadow-lg'
								active
								status='online'
							>
								<AvatarImage
					...
					<Section id='about' className='scroll-mt-28 md:scroll-mt-32 animate-fade-in'>
						...
						<p className='text-pretty font-mono text-sm text-muted-foreground mb-6'>
							{data.summary}
						</p>
						<StatsSection />
					</Section>
					...
					<Section id='education' className='scroll-mt-28 md:scroll-mt-32 animate-fade-in'>
						<h2 className='text-xl font-bold'>Education & Certification Programs</h2>
						{data.education.map((education) => (
							<Card
								key={education.school}
								className='transition-all duration-300 hover:shadow-lg hover:border-primary/20 animate-fade-in'
							>
								<CardHeader>
								...
								<CardContent className='mt-2 mb-4 text-xs'>
									<div className='flex flex-col md:flex-row md:items-center justify-between gap-x-2 text-sm'>
										...
										<time
											...
											dateTime={`${education.start}/${education.end}`}
										>
					...
					<Section
						id='projects'
						className='print-force-new-page scroll-mb-16 scroll-mt-28 md:scroll-mt-32 animate-fade-in'
					>
